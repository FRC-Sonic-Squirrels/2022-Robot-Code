...
public class NewClimbCommand extends SequentialCommandGroup {
  ...
  public NewClimbCommand(ElevatorSubsystem elevator, ArmSubsystem arm) {
    addCommands(
      new MotionMagicControl(elevator, -0.5, 0.05, 5, 10),

      new ArmSetAngle(arm, Constants.ArmConstants.CLIMBING_MIDDLE_ANGLE),

      new MotionMagicControl(elevator, 5, 0.05, 5, cruiseVelocity)
