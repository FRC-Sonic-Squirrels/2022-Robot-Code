...
public class COOPERHigh extends SequentialCommandGroup {
  /** Creates a new COOPERHigh. */
  public COOPERHigh(ElevatorSubsystem elevator, ArmSubsystem arm, LimelightSubsystem limelight, Drivetrain drivetrain) {
    addCommands(
