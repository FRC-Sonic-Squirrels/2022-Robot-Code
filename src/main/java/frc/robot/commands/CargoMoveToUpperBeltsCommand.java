...
public class CargoMoveToUpperBeltsCommand extends CommandBase {
  /** Creates a new CargoMoveToUpperBeltsCommand. */
  CargoSubsystem m_cargoSubsystem;

  public CargoMoveToUpperBeltsCommand(CargoSubsystem cargoSubsystem) {
